...
public final class Geometry {
     ...
     * @return new Bar
     */
    public static Collider createBar(int firstCornerX, int firstCornerY, int secondCornerX, int secondCornerY) throws BarBarCollision {
        throw new BarBarCollision();
    }
